...
<template>
  ...
  >
    ...
    <div class="flex gap-4 item-center justify-center my-4">
      <button
        type="button"
        class="py-2 px-4 flex justify-center items-center text-gray-700 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg border border-gray-200"
